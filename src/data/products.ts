...
export const products = [
  {
    ...
    name: "Cinnamon Buns",
    price: 15.00,
    description: "Freshly baked, warm cinnamon buns with sweet glaze",
  ...
  },
  {
    ...
    price: 20.00,
    description: "Selection of delicious freshly baked pastries",
    image: "https://images.unsplash.com/photo-1517433670267-08bbd4be890f?auto=format&fit=crop&q=80"
  },
  {
    id: 6,
    name: "Photobooth Session for 10 pictures",
    price: 30.00,
  ...
  {
    id: 9,
    name: "Ice Coffee 250ml",
    price: 10.00,
    description: "Refreshing iced coffee perfect for a summer day",
    image: "https://cdn.qwenlm.ai/output/e6c32d1f-21bc-4a2f-b447-09eb92b016c8/t2i/918a7ebd-df63-408b-bcf4-11d91d51140c/50f335c2-54dc-4aa7-802a-b0884edea6ba.png"
  },
    {	
	id: 10,
    name: "Ice Coffee 500ml",
    price: 15.00,
    description: "In a different size for even more enjoyment",
  ...
  {	
    ...
    name: "Muffins",
    price: 5.00,
    description: "Freshly baked muffins ready to be eaten",
  ...
  },
  {
    ...
    name: "Raffle Bundle",
    price: 50.00,
    description: "Win amazing prizes including teddy bear, mug, snacks, drinking bottle and perfume",
  ...
  },
   {
    ...
    name: "Car Wash",
    price: 50.00,
    description: "Car wash for the hardworking teachers that would like their car to shine!",
    image: "https://r2.flux1.ai/result-4LidFYRRyM.png"
  }
];
